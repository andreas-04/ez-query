...
const (
	EmployeeService_GetEmployee_FullMethodName   = "/workforce.employee.v1.EmployeeService/GetEmployee"
	EmployeeService_ListEmployees_FullMethodName = "/workforce.employee.v1.EmployeeService/ListEmployees"
)
...
var EmployeeService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "workforce.employee.v1.EmployeeService",
